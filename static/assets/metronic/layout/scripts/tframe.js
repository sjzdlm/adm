...
var TFrame = function() {
    ...
    var handleTheme = function() {
        ...
        var resetLayout = function() {
            ...
            if ($('.page-container').parent(".container").size() === 1) {alert('1');
                $('.page-container').insertAfter('body > .clearfix');
            }

            if ($('.page-footer > .container').size() === 1) {alert('2');
                $('.page-footer').html($('.page-footer > .container').html());
            } else if ($('.page-footer').parent(".container").size() === 1) {alert('3');
...
alert('4');
        ...
        var setLayout = function() {
			//alert('aaa');
            var layoutOption = "boxed";// $('.layout-option', panel).val();
